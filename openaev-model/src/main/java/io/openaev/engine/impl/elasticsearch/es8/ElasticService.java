...
import static io.openaev.engine.impl.elasticsearch.es8.ElasticUtils.*;
...
import es8.co.elastic.clients.elasticsearch._types.*;
...
import es8.co.elastic.clients.elasticsearch.core.*;
import es8.co.elastic.clients.elasticsearch.core.bulk.BulkResponseItem;
import es8.co.elastic.clients.elasticsearch.core.search.Hit;
