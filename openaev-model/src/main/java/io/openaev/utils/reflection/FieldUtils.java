...
public class FieldUtils {
  ...
  public static List<Field> getAllDeclaredAnnotatedFields(final Class<?> type, final Class<? extends Annotation> annotationType) {
    return getAllFields(type).stream().filter(field -> field.getAnnotation(annotationType) != null).toList();
  }
