  ...
  @Query(
      value =
          "WITH changed_assets AS ("
              ...
              + "COALESCE(GREATEST(a.asset_updated_at, max(i.inject_updated_at), max(e.exercise_updated_at), max(s.scenario_updated_at), max(f.finding_updated_at)), a.asset_updated_at) as endpoint_updated_at, "
