  ...
  @Query(
      value =
          "WITH changed_scenarios AS ("
              ...
              + "COALESCE(GREATEST(s.scenario_updated_at, max(inj.inject_updated_at), max(ic.injector_contract_updated_at)), s.scenario_updated_at) as scenario_injects_updated_at, "
