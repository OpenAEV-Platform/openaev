...
@lombok.Getter
public class OcsfClassApplicationLifecycle extends OcsfClass {
  ...
  /**
   * The application that was affected by the lifecycle event. This also applies to self-updating
   * application systems.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "app")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectProduct appField;

  /**
   * The application that was affected by the lifecycle event. This also applies to self-updating
   * application systems. Product identity, such as vendor and version, can be conveyed via the
   * nested <code>product</code> attribute.
   */
