...
@lombok.Getter
public class OcsfClassModuleActivity extends OcsfClass {
  ...
  /**
   * The actor that performed the activity on the target <code>module</code>. For example, the
   * process that loaded a module into memory.
   */
