...
@lombok.Getter
public class OcsfClassConfigState extends OcsfClass {
  ...
  /**
   * The CIS Benchmark Result object captures results generated from benchmark evaluations as
   * defined by the Center for Internet Security (<a target='_blank'
   * href='https://www.cisecurity.org/cis-benchmarks/'>CIS</a>).
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "cis_benchmark_result")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectCisBenchmarkResult cisBenchmarkResultField;
