...
@lombok.Getter
public class OcsfClassGroupManagement extends OcsfClass {
  ...
  /**
   * The normalized identifier of the activity that triggered the event. The target of each activity
   * is the <code>group</code> attribute.
   */
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "iam_roles")
  private java.util.List<io.openaev.ocsf.schema.v190.objects.OcsfObjectIamRole> iamRolesField;
  ...
  /** A subgroup added to or removed from <code>group</code>. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "subgroup")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectGroup subgroupField;
  ...
  /**
   * The intended state of the <code>group</code> after the update. On <code>Success</code>,
   * represents the actual post-update state.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "updated_group")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectGroup updatedGroupField;

  /** A user that was added to or removed from <code>group</code>. */
  ...
  /** Users that were added to or removed from <code>group</code>. */
