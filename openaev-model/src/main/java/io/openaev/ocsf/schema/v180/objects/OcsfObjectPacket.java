...
public class OcsfObjectPacket extends OcsfObject {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT encodingField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "encoding_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT encodingIdField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "end_offset")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT endOffsetField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "format")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT formatField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "format_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT formatIdField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "sequence_number")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT sequenceNumberField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT sourceIdField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "start_offset")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT startOffsetField;
