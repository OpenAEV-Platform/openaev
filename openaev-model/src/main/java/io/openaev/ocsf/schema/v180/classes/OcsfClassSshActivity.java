...
@lombok.Getter
public class OcsfClassSshActivity extends OcsfClass {
  ...
  /**
   * The SSH authentication type, normalized to the caption of 'auth_type_id'. In the case of
   * 'Other', it is defined by the event source.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "auth_type")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT authTypeField;

  /** The normalized identifier of the SSH authentication type. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "auth_type_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT authTypeIdField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "client_hassh")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectHassh clientHasshField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "server_hassh")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectHassh serverHasshField;
