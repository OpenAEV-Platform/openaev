...
@lombok.Getter
public class OcsfClassIamAnalysisFinding extends OcsfClass {
  /**
   * Describes access relationships and pathways between identities, resources, focusing on who can
   * access what and through which mechanisms. This evaluates access levels (read/write/admin),
   * access types (direct, cross-account, public, federated), and the conditions under which access
   * is granted. Use this for resource-centric security assessments such as external access
   * discovery, public exposure analysis, etc.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "access_analysis_result")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectAccessAnalysisResult
      accessAnalysisResultField;
  ...
  /**
   * Details about applications, services, or systems that are accessible based on the IAM analysis.
   * For identity-centric analysis, this represents applications the identity can access. For
   * resource-centric analysis, this represents applications that can access the resource.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "applications")
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectApplication>
      applicationsField;
  ...
  /**
   * Describes usage activity and other metrics of an Identity i.e. AWS IAM User, GCP IAM Principal,
   * etc.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "identity_activity_metrics")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectIdentityActivityMetrics
      identityActivityMetricsField;
  ...
  /**
   * Describes analysis results of permissions, policies directly associated with an identity (user,
   * role, or service account). This evaluates what permissions an identity has been granted through
   * attached policies, which privileges are actively used versus unused, and identifies potential
   * over-privileged access. Use this for identity-centric security assessments such as privilege
   * audits, dormant permission discovery, and least-privilege compliance analysis.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "permission_analysis_results")
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectPermissionAnalysisResult>
      permissionAnalysisResultsField;
  ...
  /**
   * Details about resources involved in the IAM analysis. For identity-centric analysis, this
   * represents resources the identity can access. For resource-centric analysis, this represents
   * the resource being analyzed and related resources in the access chain.
   */
  ...
  /**
   * Details about the identity (user, role, service account, or other principal) that is the
   * subject of the IAM analysis. This provides context about the identity being evaluated for
   * security risks and access patterns.
   */
