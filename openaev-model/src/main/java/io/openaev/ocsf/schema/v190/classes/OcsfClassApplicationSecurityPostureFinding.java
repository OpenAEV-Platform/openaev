...
@lombok.Getter
public class OcsfClassApplicationSecurityPostureFinding extends OcsfClass {
   ...
   * Application Security tool or other Developer-centric tooling. Applications can be defined as
   * Kubernetes resources, Containerized resources, or application hosting-specific cloud sources
   * such as AWS Elastic BeanStalk, AWS Lightsail, or Azure Logic Apps.
   */
  ...
  /**
   * The event class name, as defined by class_uid value: <code>Application Security Posture Finding
   * </code>.
   */
  ...
  /**
   * Provides compliance context to vulnerabilities and other weaknesses that are reported as part
   * of an Application Security or Vulnerability Management tool's built-in compliance framework
   * mapping.
   */
  ...
  /**
   * Describes the recommended remediation steps to address identified vulnerabilities or
   * weaknesses.
   */
