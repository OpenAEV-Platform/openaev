...
@lombok.Getter
public class OcsfClassRegistryValueActivity extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "prev_reg_value")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectRegValue prevRegValueField;
