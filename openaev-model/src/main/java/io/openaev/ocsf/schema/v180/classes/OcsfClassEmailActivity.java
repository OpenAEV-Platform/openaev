...
@lombok.Getter
public class OcsfClassEmailActivity extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "attempt")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT attemptField;
  ...
  /**
   * The initial connection response that a messaging server receives after it connects to an email
   * server.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "banner")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT bannerField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT commandField;
  ...
  /**
   * The direction of the email relative to the scanning host or organization.Email scanned at an
   * internet gateway might be characterized as inbound to the organization from the Internet,
   * outbound from the organization to the Internet, or internal within the organization. Email
   * scanned at a workstation might be characterized as inbound to, or outbound from the
   * workstation.
   */
  ...
  /**
   * The sender address from the transmission envelope. This reflects the actual sending party and
   * may differ from the 'From' header in the message.
   */
  ...
  /**
   * The identifier that tracks a message that travels through multiple points of a messaging
   * service.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "message_trace_uid")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT messageTraceUidField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "smtp_hello")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT smtpHelloField;
  ...
  /**
   * The recipient address from the transmission envelope. This may differ from the 'To' header and
   * represents where the message was actually delivered.
   */
