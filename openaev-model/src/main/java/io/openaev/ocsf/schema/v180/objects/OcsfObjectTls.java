...
public class OcsfObjectTls extends OcsfObject {
  /**
   * The integer value of TLS alert if present. The alerts are defined in the TLS specification in
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT cipherField;
  ...
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectTlsExtension>
      extensionListField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT handshakeDurField;

  /** The MD5 hash of a JA3 string. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "ja3_hash")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectFingerprint ja3HashField;

  /** The MD5 hash of a JA3S string. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "ja3s_hash")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectFingerprint ja3sHashField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT sniField;
