...
@lombok.Getter
public class OcsfClassProcessActivity extends OcsfClass {
  ...
  /**
   * The actor that performed the activity on the target <code>process</code>. For example, the
   * process that started a new process or injected code into another process.
   */
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "actual_permissions")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT actualPermissionsField;

  /**
   * The AI Model object describes the characteristics of an AI/ML model. Examples include language
   * models like GPT-4, embedding models like text-embedding-ada-002, and computer vision models
   * like CLIP.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "ai_model")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectAiModel aiModelField;
  ...
  /**
   * The exit code reported by a process when it terminates. The convention is that zero indicates
   * success and any non-zero exit code indicates that some error occurred.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "exit_code")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT exitCodeField;
  ...
  /**
   * The process injection method, normalized to the caption of the injection_type_id value. In the
   * case of 'Other', it is defined by the event source.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "injection_type")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT injectionTypeField;

  /** The normalized identifier of the process injection method. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "injection_type_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT injectionTypeIdField;
  ...
  /**
   * The specific type of <code>Launch</code> activity, normalized to the caption of the <code>
   * launch_type_id</code> value. In the case of <code>Other</code> it is defined by the event
   * source.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "launch_type")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT launchTypeField;

  /** The normalized identifier for the specific type of <code>Launch</code> activity. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "launch_type_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT launchTypeIdField;
  ...
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectMessageContext messageContextField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "requested_permissions")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT requestedPermissionsField;
