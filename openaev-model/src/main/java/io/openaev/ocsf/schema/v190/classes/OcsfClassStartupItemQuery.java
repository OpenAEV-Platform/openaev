...
@lombok.Getter
public class OcsfClassStartupItemQuery extends OcsfClass {
  ...
  /**
   * The startup item object describes an application component that has associated startup criteria
   * and configurations.
   */
