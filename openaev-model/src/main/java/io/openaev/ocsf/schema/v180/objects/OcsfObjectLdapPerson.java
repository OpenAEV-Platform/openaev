...
public class OcsfObjectLdapPerson extends OcsfObject {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeDatetimeT deletedTimeDtField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "deleted_time")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeTimestampT deletedTimeField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "department")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT departmentField;
  ...
  private java.util.List<io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeEmailT> emailAddrsField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "employee_uid")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT employeeUidField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "given_name")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT givenNameField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "hire_time_dt")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeDatetimeT hireTimeDtField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "hire_time")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeTimestampT hireTimeField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "job_title")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT jobTitleField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeDatetimeT lastLoginTimeDtField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "last_login_time")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeTimestampT lastLoginTimeField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "ldap_cn")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT ldapCnField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "ldap_dn")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT ldapDnField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "leave_time_dt")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeDatetimeT leaveTimeDtField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "leave_time")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeTimestampT leaveTimeField;
  ...
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectUser managerField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT officeLocationField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT surnameField;
