...
@lombok.Getter
public class OcsfClassSecurityFinding extends OcsfClass {
  ...
  /**
   * An array of <a target='_blank' href='https://attack.mitre.org'>MITRE ATT&CK®</a> objects
   * describing the tactics, techniques & sub-techniques associated to the Finding.
   */
  ...
  /**
   * The CIS Critical Security Controls is a list of top 20 actions and practices an organization’s
   * security team can take on such that cyber attacks or malware, are minimized and prevented.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "cis_csc")
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectCisCsc> cisCscField;
  ...
  /**
   * The compliance object provides context to compliance findings (e.g., a check against a specific
   * regulatory or best practice framework such as CIS, NIST etc.) and contains compliance related
   * details.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "compliance")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectCompliance complianceField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "finding")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectFinding findingField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "nist")
  private java.util.List<io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT> nistField;
