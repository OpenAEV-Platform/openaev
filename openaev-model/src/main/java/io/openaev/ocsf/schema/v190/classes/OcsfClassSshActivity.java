...
public class OcsfClassSshActivity extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT authTypeField;

  /** The normalized identifier of the SSH authentication type. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "auth_type_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT authTypeIdField;
  ...
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectHassh clientHasshField;
  ...
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectHassh serverHasshField;
