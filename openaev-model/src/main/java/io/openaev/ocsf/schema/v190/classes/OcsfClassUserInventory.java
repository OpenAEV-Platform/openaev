...
@lombok.Getter
public class OcsfClassUserInventory extends OcsfClass {
   ...
   * user inventory data, that could be a particular process or script that is run to scrape the
   * user data. For example, it could be a powershell process that runs to pull data from the Azure
   * AD graph API.
   */
