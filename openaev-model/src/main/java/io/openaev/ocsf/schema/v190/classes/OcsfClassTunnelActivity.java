...
@lombok.Getter
public class OcsfClassTunnelActivity extends OcsfClass {
  ...
  /**
   * The networking protocol associated with the tunnel. E.g. <code>IPSec</code>, <code>SSL</code>,
   * <code>GRE</code>.
   */
  ...
  /**
   * Traffic refers to the amount of data moving across the tunnel at a given point of time. Ex:
   * <code>bytes_in</code> and <code>bytes_out</code>.
   */
  ...
  /**
   * The information about the virtual tunnel interface, e.g. <code>utun0</code>. This is usually
   * associated with the private (rfc-1918) ip of the tunnel.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "tunnel_interface")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectNetworkInterface tunnelInterfaceField;

  /**
   * The type of tunnel configuration, normalized to the caption of the <code>tunnel_type_id</code>
   * value, indicating the scope of traffic routed through the connection. Example: <code>
   * Split Tunnel</code> or <code>Full Tunnel</code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "tunnel_type")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT tunnelTypeField;

  /**
   * The normalized identifier for the type of tunnel configuration, indicating the scope of traffic
   * routed through the connection. Example: <code>1 (Split Tunnel)</code> or <code>2 (Full Tunnel)
   * </code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "tunnel_type_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT tunnelTypeIdField;
