...
public class OcsfObjectNetworkTraffic extends OcsfObject {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT bytesInField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "bytes_missed")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT bytesMissedField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "bytes_out")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT bytesOutField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "chunks")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT chunksField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "chunks_in")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT chunksInField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "chunks_out")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT chunksOutField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT packetsField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "packets_in")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT packetsInField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "packets_out")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT packetsOutField;
