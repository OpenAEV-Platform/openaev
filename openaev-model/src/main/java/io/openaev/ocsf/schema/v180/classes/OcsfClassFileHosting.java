...
@lombok.Getter
public class OcsfClassFileHosting extends OcsfClass {
  /** The list of requested access rights. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "access_list")
  private java.util.List<io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT> accessListField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT shareField;

  /**
   * The share type, normalized to the caption of the share_type_id value. In the case of 'Other',
   * it is defined by the event source.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "share_type")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT shareTypeField;

  /** The normalized identifier of the share type. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "share_type_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT shareTypeIdField;
