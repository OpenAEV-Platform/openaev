...
@lombok.Getter
public class OcsfClassHttpActivity extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "http_cookies")
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectHttpCookie> httpCookiesField;
   ...
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "http_status")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT httpStatusField;
