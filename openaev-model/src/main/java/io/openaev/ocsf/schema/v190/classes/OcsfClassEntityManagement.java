...
@lombok.Getter
public class OcsfClassEntityManagement extends OcsfClass {
  /** The list of requested access rights. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "access_list")
  private java.util.List<io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT> accessListField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "entity")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectManagedEntity entityField;

  /** The updated managed entity. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "entity_result")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectManagedEntity entityResultField;
  ...
  /**
   * The intended state of the <code>entity</code> after the update. On <code>Success</code>,
   * represents the actual post-update state.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "updated_entity")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectManagedEntity updatedEntityField;
}
