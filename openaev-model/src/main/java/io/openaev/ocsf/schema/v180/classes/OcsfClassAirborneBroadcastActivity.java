...
@lombok.Getter
public class OcsfClassAirborneBroadcastActivity extends OcsfClass {
  ...
  /**
   * The Aircraft object represents any aircraft or otherwise airborne asset such as an unmanned
   * system, airplane, balloon, spacecraft, or otherwise. The Aircraft object is intended to
   * normalized data captured or otherwise logged from active radar, passive radar, multi-spectral
   * systems, or the Automatic Dependant Broadcast - Surveillance (ADS-B), and/or Mode S systems.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "aircraft")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectAircraft aircraftField;
  ...
  /**
   * The destination network endpoint for the ADS-B system, if telemetry is being remotely
   * broadcasted.
   */
  ...
  /**
   * The specific protocol associated with the ADS-B system. E.g. <code>ADS-B UAT</code> or <code>
   * ADS-B ES</code>.
   */
  ...
  /**
   * Recent average RSSI (signal power) measured in dbFS. This value will always be negative, e.g.,
   * <code>-87.13</code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "rssi")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT rssiField;
  ...
  /**
   * Traffic refers to the amount of data transmitted from a ADS-B remote monitoring system at a
   * given point of time. Ex: <code>bytes_in</code> and <code>bytes_out</code>.
   */
