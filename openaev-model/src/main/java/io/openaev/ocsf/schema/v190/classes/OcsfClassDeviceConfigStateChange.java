...
@lombok.Getter
public class OcsfClassDeviceConfigStateChange extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "prev_security_level")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT prevSecurityLevelField;

  /** The previous security level of the entity */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "prev_security_level_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT prevSecurityLevelIdField;

  /** The previous security states of the device. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "prev_security_states")
  private java.util.List<io.openaev.ocsf.schema.v190.objects.OcsfObjectSecurityState>
      prevSecurityStatesField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "security_level")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT securityLevelField;

  /** The current security level of the entity */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "security_level_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT securityLevelIdField;

  /** The current security states of the device. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "security_states")
  private java.util.List<io.openaev.ocsf.schema.v190.objects.OcsfObjectSecurityState>
      securityStatesField;
  ...
  /**
   * The Config Change Stat, normalized to the caption of the state_id value. In the case of
