...
@lombok.Getter
public class OcsfClassBaseEvent extends OcsfClass {
  ...
  /**
   * The event category name, as defined by the <code>category_uid</code> value. The value must
   * match the caption defined for the corresponding <code>category_uid</code> enum value (e.g.,
   * <code>"Findings"</code> for <code>category_uid: 2</code>).
   */
