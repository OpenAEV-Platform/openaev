...
@lombok.Getter
public class OcsfClassDhcpActivity extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "is_renewal")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeBooleanT isRenewalField;
   ...
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "lease_dur")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT leaseDurField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "relay")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectNetworkInterface relayField;
  ...
  /**
   * The unique identifier of the transaction. This is typically a random number generated from the
   * client to associate a dhcp request/response pair.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "transaction_uid")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT transactionUidField;
