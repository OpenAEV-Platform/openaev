...
@lombok.Getter
public class OcsfClassUserManagement extends OcsfClass {
   ...
   * is the <code>user</code> attribute.
   */
  ...
  /**
   * Details about the authentication factors associated with the MFA Factor Enable/Disable
   * activities.
   */
  ...
  /** The event class name, as defined by class_uid value: <code>User Management</code>. */
  ...
  /**
   * The intended state of the <code>user</code> after the update. On <code>Success</code>,
   * represents the actual post-update state.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "updated_user")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectUser updatedUserField;
