...
@lombok.Getter
public class OcsfClassDroneFlightsActivity extends OcsfClass {
  ...
  /**
   * The authentication type as defined by the caption of <code>auth_protocol_id</code>. In the case
  ...
  /**
   * The normalized identifier of the authentication type used to authorize a flight plan or
   * mission.
   */
  ...
  /**
   * UA Classification - Allows a region to classify UAS in a regional specific manner. The format
  ...
  /**
   * This optional, free-text field enables the operator to describe the purpose of a flight, if so
   * desired.
   */
  ...
  /**
   * The destination network endpoint of the Unmanned Aerial System (UAS), Counter Unmanned Aerial
   * System (CUAS) platform, or other unmanned systems monitoring and/or sensing infrastructure.
   */
  ...
  /**
   * The networking protocol associated with the Remote ID device or beacon. E.g. <code>BLE</code>,
   * <code>LTE</code>, <code>802.11</code>.
   */
  ...
  /**
   * The source network endpoint of the Unmanned Aerial System (UAS), Counter Unmanned Aerial System
   * (CUAS) platform, or other unmanned systems monitoring and/or sensing infrastructure.
   */
  ...
  /**
   * The normalized Operational status for the Unmanned Aerial System (UAS) normalized to the
   * caption of the <code>status_id</code> value. In the case of 'Other', it is defined by the
   * source.
   */
  ...
  /**
   * Traffic refers to the amount of data transmitted from a Unmanned Aerial System (UAS) or Counter
   * Unmanned Aerial System (UAS) (CUAS) system at a given point of time. Ex: <code>bytes_in</code>
   * and <code>bytes_out</code>.
   */
  ...
  /**
   * The Unmanned Aerial System object describes the characteristics, Position Location Information
   * (PLI), and other metadata of Unmanned Aerial Systems (UAS) and other unmanned and drone systems
   * used in Remote ID. Remote ID is defined in the Standard Specification for Remote ID and
   * Tracking (ASTM Designation: F3411-22a) <a target='_blank'
   * href='https://cdn.standards.iteh.ai/samples/112830/71297057ac42432880a203654f213709/ASTM-F3411-22a.pdf'>ASTM
   * F3411-22a</a>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "unmanned_aerial_system")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectUnmannedAerialSystem
      unmannedAerialSystemField;

  /**
   * The UAS Operating Area object describes details about a precise area of operations for a UAS
   * flight or mission.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "unmanned_system_operating_area")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectUnmannedSystemOperatingArea
      unmannedSystemOperatingAreaField;

  /** The human or machine operator of an Unmanned System. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "unmanned_system_operator")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectUser unmannedSystemOperatorField;
