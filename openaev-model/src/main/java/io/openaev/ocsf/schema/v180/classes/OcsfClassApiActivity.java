...
@lombok.Getter
public class OcsfClassApiActivity extends OcsfClass {
  ...
  /**
   * The trace object contains information about distributed traces which are critical to
   * observability and describe how requests move through a system, capturing each step's timing and
   * status.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "trace")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectTrace traceField;
