...
@lombok.Getter
public class OcsfClassScheduledJobActivity extends OcsfClass {
  ...
  /**
   * The intended state of the <code>job</code> after the update. On <code>Success</code>,
   * represents the actual post-update state.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "updated_job")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectJob updatedJobField;
}
