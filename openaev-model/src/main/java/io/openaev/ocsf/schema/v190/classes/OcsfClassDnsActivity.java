...
public class OcsfClassDnsActivity extends OcsfClass {
  ...
  /**
   * The DNS Authority section resource records. Contains NS records pointing to authoritative name
   * servers, or a SOA record for negative responses (NXDOMAIN).
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "authority")
  ...
  /**
   * The list of DNS message header flag IDs. For Query events, populated from the query header (RD,
   * CD). For Response and Traffic events, populated from the response header, which is the complete
   * and authoritative source as it echoes all client-set flags and adds server-set flags.
   */
  ...
  /**
   * The list of DNS message header flags, normalized to the captions of the <code>flag_ids</code>
   * values.
   */
  ...
  /**
   * The Additional section of the DNS query message sent by the client, containing supplementary
   * resource records and an optional TSIG record. A DNS message has at most one TSIG record; for a
   * transaction with both query and response, the query TSIG is in <code>query_additional.tsig
   * </code> and the response TSIG is in <code>response_additional.tsig</code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "query_additional")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectDnsSection queryAdditionalField;
  ...
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT rcodeField;
  ...
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT rcodeIdField;

  /**
   * The Additional section of the DNS response message sent by the server, containing supplementary
   * resource records and an optional TSIG record. A DNS message has at most one TSIG record; for a
   * transaction with both query and response, the query TSIG is in <code>query_additional.tsig
   * </code> and the response TSIG is in <code>response_additional.tsig</code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "response_additional")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectDnsSection responseAdditionalField;

  /** The Domain Name System (DNS) response time. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "response_time_dt")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeDatetimeT responseTimeDtField;

  /** The Domain Name System (DNS) response time. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "response_time")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeTimestampT responseTimeField;
  ...
  /**
   * The 16-bit DNS transaction identifier assigned by the client and echoed unchanged in the server
   * response. This value is the same for both the query and response messages.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "transaction_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT transactionIdField;
