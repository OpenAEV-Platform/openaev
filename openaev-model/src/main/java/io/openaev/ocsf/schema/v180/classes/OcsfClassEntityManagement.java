...
public class OcsfClassEntityManagement extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectManagedEntity entityField;

  /** The updated managed entity. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "entity_result")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectManagedEntity entityResultField;
