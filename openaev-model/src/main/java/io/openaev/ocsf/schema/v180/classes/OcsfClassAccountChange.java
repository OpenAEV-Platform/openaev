...
@lombok.Getter
public class OcsfClassAccountChange extends OcsfClass {
  ...
  /**
   * The result of the user account change. It should contain the new values of the changed
   * attributes.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "user_result")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectUser userResultField;
}
