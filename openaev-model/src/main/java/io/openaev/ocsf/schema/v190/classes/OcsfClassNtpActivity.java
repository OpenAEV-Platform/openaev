...
@lombok.Getter
public class OcsfClassNtpActivity extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT delayField;
  ...
  /**
   * The dispersion in the NTP protocol is the estimated time error or uncertainty relative to the
   * reference clock in milliseconds.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "dispersion")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT dispersionField;
  ...
  /**
   * The NTP precision quantifies a clock's accuracy and stability in log2 seconds, as defined in
   * RFC-5905.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "precision")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT precisionField;
  ...
  /**
   * The stratum level of the NTP server's time source, normalized to the caption of the stratum_id
   * value.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "stratum")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT stratumField;

  /**
   * The normalized identifier of the stratum level of an NTP server's time source, as defined in
   * RFC 5905. Levels range from 0 to 16, with lower numbers representing higher accuracy and
   * greater proximity to the root clock.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "stratum_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT stratumIdField;
