...
public class OcsfClassNetworkActivity extends OcsfClass {
  ...
  /**
   * The responder of the network connection. In some contexts an event source cannot correctly
   * identify the responder. Refer to <code>is_src_dst_assignment_known</code> for certainty.
   */
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeBooleanT isSrcDstAssignmentKnownField;
  ...
  /**
   * The initiator of the network connection. In some contexts an event source cannot correctly
   * identify the initiator. Refer to <code>is_src_dst_assignment_known</code> for certainty.
   */
