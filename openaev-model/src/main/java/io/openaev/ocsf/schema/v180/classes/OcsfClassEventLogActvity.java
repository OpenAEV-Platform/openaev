...
@lombok.Getter
public class OcsfClassEventLogActvity extends OcsfClass {
   ...
   * The
   *
   * <p style='display:inline;color:red'>targeted endpoint for the event log activity.
   */
   ...
   * The file
   *
   * <p style='display:inline;color:red'>targeted by the activity. Example: <code>/var/log/audit.log
   * </code>
   */
   ...
   *
   * <p style='display:inline;color:red'>targeted by the activity. Example: Windows <code>Security
   * </code>.
   */
   ...
   *
   * <p style='display:inline;color:red'>targeted by the activity.<br>
   * Example: <code>Microsoft-Windows-Security-Auditing</code>, <code>Auditd</code>, or <code>Syslog
   * </code>.
   */
  ...
  /**
   * The log type, normalized to the caption of the <code>log_type_id</code> value. In the case of
   * 'Other', it is defined by the event source.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "log_type")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT logTypeField;

  /** The normalized log type identifier. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "log_type_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT logTypeIdField;
   ...
   * Example: <code>0</code>, <code>8</code>, or <code>21</code> for <a target='_blank'
   ...
   * Example: <code>Success</code>, <code>Privilege Missing</code>, or <code>Invalid Parameter
   * </code> for <a target='_blank'
   * href='https://learn.microsoft.com/en-us/previous-versions/windows/desktop/eventlogprov/cleareventlog-method-in-class-win32-nteventlogfile'>Windows
   * ClearEventLog</a>.
   */
