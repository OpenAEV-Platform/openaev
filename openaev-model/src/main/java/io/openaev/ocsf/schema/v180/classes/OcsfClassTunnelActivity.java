...
public class OcsfClassTunnelActivity extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectNetworkInterface tunnelInterfaceField;

  /** The tunnel type. Example: <code>Split</code> or <code>Full</code>. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "tunnel_type")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT tunnelTypeField;

  /** The normalized tunnel type ID. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "tunnel_type_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT tunnelTypeIdField;
