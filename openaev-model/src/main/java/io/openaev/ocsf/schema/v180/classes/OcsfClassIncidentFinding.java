...
public class OcsfClassIncidentFinding extends OcsfClass {
   ...
   * describing the tactics, techniques & sub-techniques associated to the Incident.
   */
  ...
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectFindingInfo>
  ...
  /**
   * The normalized status of the Incident normalized to the caption of the status_id value. In the
