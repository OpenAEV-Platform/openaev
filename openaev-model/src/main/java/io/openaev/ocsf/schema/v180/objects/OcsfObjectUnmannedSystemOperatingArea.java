...
public class OcsfObjectUnmannedSystemOperatingArea extends OcsfObject {
  ...
  /**
   * A two-element array, containing a longitude/latitude pair. The format conforms with <a
   * target='_blank' href='https://geojson.org'>GeoJSON</a>. For example: <code>[-73.983, 40.719]
   * </code>.
   */
  ...
  /**
   * Geohash of the geo-coordinates (latitude and longitude).<a target='_blank'
   * href='https://en.wikipedia.org/wiki/Geohash'>Geohashing</a> is a geocoding system used to
   * encode geographic coordinates in decimal degrees, to a single string.
   */
