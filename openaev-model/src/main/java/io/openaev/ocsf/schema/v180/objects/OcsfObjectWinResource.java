...
public class OcsfObjectWinResource extends OcsfObject {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT detailsField;
  ...
  /**
   * The Windows service acting as the object server for the resource object, such as Security or
