...
@lombok.Getter
public class OcsfClassRoleManagement extends OcsfClass {
  ...
  /** The event class name, as defined by class_uid value: <code>Role Management</code>. */
  ...
  /** A list of privileges assigned to or removed from <code>iam_role</code>. */
  ...
  /** Resources assigned or removed from <code>iam_role</code>. */
  ...
  /**
   * The intended state of the <code>iam_role</code> after the update. On <code>Success</code>,
   * represents the actual post-update state.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "updated_role")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectIamRole updatedRoleField;
}
