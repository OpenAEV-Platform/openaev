...
@lombok.Getter
public class OcsfClassDatastoreActivity extends OcsfClass {
  ...
  /**
   * The database object is used for databases which are typically datastore services that contain
   * an organized collection of structured and unstructured data or a types of data.
   */
  ...
  /**
   * The query info object holds information related to data access within a datastore. To access,
   * manipulate, delete, or retrieve data from a datastore, a database query must be written using a
   * specific syntax.
   */
  ...
  /**
   * The table object represents a table within a structured relational database or datastore, which
   * contains columns and rows of data that are able to be create, updated, deleted and queried.
   */
