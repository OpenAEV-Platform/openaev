...
public class OcsfObjectCve extends OcsfObject {
   ...
   * href='https://www.first.org/cvss/'>CVSS</a>) scores from the advisory that are related to the
   * vulnerability.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "cvss")
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectCvss> cvssField;

  /**
   * The CWE object represents a weakness in a software system that can be exploited by a threat
   * actor to perform an attack. The CWE object is based on the <a target='_blank'
  ...
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectCwe cweField;

  /**
   * The <a target='_blank' href='https://cwe.mitre.org/'>Common Weakness Enumeration (CWE)</a>
   * unique identifier. For example: <code>CWE-787</code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "cwe_uid")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT cweUidField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeUrlT cweUrlField;
   ...
   * information about vulnerabilities (CVEs) with evidence of actual exploitation in-the-wild. (<a
   * target='_blank' href='https://www.first.org/epss/'>EPSS</a>).
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "epss")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectEpss epssField;
  ...
  /**
   * The vulnerability type as selected from a large dropdown menu during CVE refinement.Most
   * frequently used vulnerability types are: <code>DoS</code>, <code>Code Execution</code>, <code>
   * Overflow</code>, <code>Memory Corruption</code>, <code>Sql Injection</code>, <code>XSS</code>,
   * <code>Directory Traversal</code>, <code>Http Response Splitting</code>, <code>Bypass something
   * </code>, <code>Gain Information</code>, <code>Gain Privileges</code>, <code>CSRF</code>, <code>
   * File Inclusion</code>. For more information see <a target='_blank'
   * href='https://www.cvedetails.com/vulnerabilities-by-types.php'>Vulnerabilities By Type</a>
   * distributions.
   */
