...
@lombok.Getter
public class OcsfClassProcessRemediationActivity extends OcsfClass {
  ...
  /**
   * Matches the countermeasure tactic. Note: the Model tactic is not supported by the OCSF
