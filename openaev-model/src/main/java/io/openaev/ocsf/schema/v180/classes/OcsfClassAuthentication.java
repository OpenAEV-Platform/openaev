...
public class OcsfClassAuthentication extends OcsfClass {
  /**
   * The account switch method, normalized to the caption of the account_switch_type_id value. In
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT accountSwitchTypeField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT accountSwitchTypeIdField;
  ...
  /**
   * The authentication protocol as defined by the caption of <code>auth_protocol_id</code>. In the
  ...
  /**
   * The authentication token, ticket, or assertion, e.g. <code>Kerberos</code>, <code>OIDC</code>,
   * <code>SAML</code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "authentication_token")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectAuthenticationToken
  ...
  /**
   * The event category name, as defined by category_uid value: <code>Identity & Access Management
   * </code>.
   */
   ...
   *
   * <p><b>Note:</b> True if the credentials were passed in a clear text protocol such as FTP or
   * TELNET, or if Windows detected that a user's logon password was passed to the authentication
   * package in clear text.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "is_cleartext")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeBooleanT isCleartextField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeBooleanT isNewLogonField;
  ...
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectProcess logonProcessField;

  /**
   * The logon type, normalized to the caption of the logon_type_id value. In the case of 'Other',
   * it is defined by the event source.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "logon_type")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT logonTypeField;

  /** The normalized logon type identifier. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "logon_type_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT logonTypeIdField;
  ...
  /**
   * The details about the authentication request. For example, possible details for Windows logon
   * or logoff events are:
   *
   * <ul>
   *   <li>Success
   *       <ul>
   *         <li>LOGOFF_USER_INITIATED
   *         <li>LOGOFF_OTHER
   *       </ul>
   *   <li>Failure
   *       <ul>
   *         <li>USER_DOES_NOT_EXIST
   *         <li>INVALID_CREDENTIALS
   *         <li>ACCOUNT_DISABLED
   *         <li>ACCOUNT_LOCKED_OUT
   *         <li>PASSWORD_EXPIRED
   *       </ul>
   * </ul>
   */
