...
public class OcsfObjectRegValue extends OcsfObject {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeBooleanT isDefaultField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeBytestringT regBinaryDataField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "reg_integer_data")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeLongT regIntegerDataField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "reg_string_data")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT regStringDataField;
