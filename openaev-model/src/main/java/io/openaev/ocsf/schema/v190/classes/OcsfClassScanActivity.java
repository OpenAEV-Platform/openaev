...
@lombok.Getter
public class OcsfClassScanActivity extends OcsfClass {
  ...
  /**
   * The command identifier that is associated with this scan event. This ID uniquely identifies the
   * proactive scan command, e.g., if remotely initiated.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "command_uid")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT commandUidField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_detections")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numDetectionsField;

  /** The number of files scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_files")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numFilesField;

  /** The number of folders scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_folders")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numFoldersField;

  /** The number of network items scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_network_items")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numNetworkItemsField;

  /** The number of processes scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_processes")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numProcessesField;

  /** The number of registry items scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_registry_items")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numRegistryItemsField;

  /** The number of items that were resolved. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_resolutions")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numResolutionsField;

  /** The number of skipped items. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_skipped_items")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numSkippedItemsField;

  /** The number of trusted items. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_trusted_items")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT numTrustedItemsField;
  ...
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectScan scanField;

  /** The unique identifier of the schedule associated with a scan job. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "schedule_uid")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT scheduleUidField;
