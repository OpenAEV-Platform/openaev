...
public class OcsfClassDeviceConfigStateChange extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT prevSecurityLevelField;

  /** The previous security level of the entity */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "prev_security_level_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT prevSecurityLevelIdField;

  /** The previous security states of the device. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "prev_security_states")
  private java.util.List<io.openaev.ocsf.schema.v180.objects.OcsfObjectSecurityState>
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT securityLevelField;

  /** The current security level of the entity */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "security_level_id")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT securityLevelIdField;
