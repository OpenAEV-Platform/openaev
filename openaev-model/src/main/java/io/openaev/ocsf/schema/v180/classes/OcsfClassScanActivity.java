...
public class OcsfClassScanActivity extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numDetectionsField;

  /** The number of files scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_files")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numFilesField;

  /** The number of folders scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_folders")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numFoldersField;

  /** The number of network items scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_network_items")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numNetworkItemsField;

  /** The number of processes scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_processes")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numProcessesField;

  /** The number of registry items scanned. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_registry_items")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numRegistryItemsField;

  /** The number of items that were resolved. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_resolutions")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numResolutionsField;

  /** The number of skipped items. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_skipped_items")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numSkippedItemsField;

  /** The number of trusted items. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "num_trusted_items")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT numTrustedItemsField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT scheduleUidField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT totalField;
