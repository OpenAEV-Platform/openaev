...
@lombok.Getter
public class OcsfClassDevicePowerStateActivity extends OcsfClass {
  ...
  /** The actor that performed the activity on the <code>device</code> object. */
  ...
  /**
   * The event class name, as defined by class_uid value: <code>Device Power State Activity</code>.
   */
