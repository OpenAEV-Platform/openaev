...
@lombok.Getter
public class OcsfClassRegistryKeyActivity extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "open_mask")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT openMaskField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "prev_reg_key")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectRegKey prevRegKeyField;
