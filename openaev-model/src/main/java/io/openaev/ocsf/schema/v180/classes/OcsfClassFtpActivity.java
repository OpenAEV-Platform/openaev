...
@lombok.Getter
public class OcsfClassFtpActivity extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "codes")
  private java.util.List<io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT> codesField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "command_responses")
  private java.util.List<io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT>
      commandResponsesField;
