...
public class OcsfClassEventLogActvity extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT logTypeField;

  /** The normalized log type identifier. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "log_type_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT logTypeIdField;
