...
@lombok.Getter
public class OcsfClassEvidenceInfo extends OcsfClass {
  ...
  /**
   * The specific resulting evidence information that was queried or discovered based on the query
   * type. Contains various child objects corresponding to the query_type_id values.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "query_evidence")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectQueryEvidence queryEvidenceField;
  ...
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeStringT queryResultField;

  /** The normalized identifier of the query result. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "query_result_id")
  private io.openaev.ocsf.schema.v190.datatypes.OcsfDatatypeIntegerT queryResultIdField;
