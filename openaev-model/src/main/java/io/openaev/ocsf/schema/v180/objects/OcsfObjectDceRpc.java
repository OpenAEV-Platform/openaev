...
public class OcsfObjectDceRpc extends OcsfObject {
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT commandResponseField;
  ...
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT opnumField;

  @com.fasterxml.jackson.annotation.JsonProperty(value = "rpc_interface")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectRpcInterface rpcInterfaceField;
}
