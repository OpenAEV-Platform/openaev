...
@lombok.Getter
public class OcsfClassFileActivity extends OcsfClass {
  /** The access mask in a platform-native format. */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "access_mask")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeIntegerT accessMaskField;
  ...
  /**
   * The name or relative pathname of a sub-component of the data object, if applicable. For
   * example: <code>attachment.doc</code>, <code>attachment.zip/bad.doc</code>, or <code>
   * part.mime/part.cab/part.uue/part.doc</code>.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "component")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT componentField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "connection_uid")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT connectionUidField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "create_mask")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT createMaskField;
  ...
  /**
   * File content differences used for change detection. For example, a common use case is to
   * identify itemized changes within INI or configuration/property setting values.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "file_diff")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT fileDiffField;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "file_result")
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectFile fileResultField;
