...
@lombok.Getter
public class OcsfClassCloudResourcesInventoryInfo extends OcsfClass {
  ...
  /**
   * The event class name, as defined by class_uid value: <code>Cloud Resources Inventory Info
   * </code>.
   */
  ...
  /**
   * Cloud service provider or SaaS platform metadata about the cloud resource(s) that are being
  ...
  /**
   * The Identity Provider that is being discovered by an inventory process, or that is related to
   * the cloud resource(s) being discovered by an inventory process.
   */
  ...
  /**
   * The cloud region where the resource is located, e.g., <code>us-isof-south-1</code>, <code>
   * eastus2</code>, <code>us-central1</code>, etc.
   */
  ...
  /**
   * The cloud resource(s) that are being discovered by an inventory process. Use this object if
   * there is not a direct object match in the class.
   */
