...
public class OcsfClassSoftwareInfo extends OcsfClass {
  ...
  private io.openaev.ocsf.schema.v180.objects.OcsfObjectPackage packageField;
  ...
  /**
   * Additional product attributes that have been discovered or enriched from a catalog or other
   * external source.
   */
  ...
  /**
   * The Software Bill of Materials (SBOM) of the device software that is being discovered by an
   * inventory process.
   */
