...
@lombok.Getter
public class OcsfClassEmailFileActivity extends OcsfClass {
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "email_uid")
  private io.openaev.ocsf.schema.v180.datatypes.OcsfDatatypeStringT emailUidField;
