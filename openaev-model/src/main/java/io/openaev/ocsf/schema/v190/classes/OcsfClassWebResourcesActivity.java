...
@lombok.Getter
public class OcsfClassWebResourcesActivity extends OcsfClass {
  ...
  /**
   * The intended state of the <code>web_resources</code> after the update. On <code>Success</code>,
   * represents the actual post-update state.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "updated_web_resources")
  private java.util.List<io.openaev.ocsf.schema.v190.objects.OcsfObjectWebResource>
      updatedWebResourcesField;
  ...
  /**
   * The results of the activity on web resources. It should contain the new values of the changed
   * attributes of the web resources.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "web_resources_result")
  private java.util.List<io.openaev.ocsf.schema.v190.objects.OcsfObjectWebResource>
      webResourcesResultField;
}
