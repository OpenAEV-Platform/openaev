...
@lombok.Getter
public class OcsfClassClipboardActivity extends OcsfClass {
  ...
  /** The event class name, as defined by class_uid value: <code>Clipboard Activity</code>. */
  ...
  @com.fasterxml.jackson.annotation.JsonProperty(value = "clipboard")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectClipboard clipboardField;
  ...
  /**
   * For a <code>Read</code> activity, this is the process which performed the <code>Write</code>.
   * In other words, <code>actor.process</code> is the process performing the paste and <code>
   * source_process</code> is the process that performed the copy.
   */
  @com.fasterxml.jackson.annotation.JsonProperty(value = "source_process")
  private io.openaev.ocsf.schema.v190.objects.OcsfObjectProcess sourceProcessField;
