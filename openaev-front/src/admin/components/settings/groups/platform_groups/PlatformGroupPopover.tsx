...
const PlatformGroupPopover: FunctionComponent<Props> = ({
  ...
  const entries = useMemo(() => {
    const canManage = ability.can(ACTIONS.MANAGE, SUBJECTS.PLATFORM_USERS_GROUPS_AND_ROLES);
    const canDelete = ability.can(ACTIONS.DELETE, SUBJECTS.PLATFORM_USERS_GROUPS_AND_ROLES);
    const result = [];
