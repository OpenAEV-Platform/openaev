...
import { type ImportMapperOutput, type ImportMapperSimpleOutput } from '../../../../utils/api-types';
...
interface Props {
  mapper: ImportMapperSimpleOutput;
  onDuplicate?: (result: ImportMapperSimpleOutput) => void;
