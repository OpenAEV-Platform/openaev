  ...
  const entries = useMemo(() => {
    ...
    if (actions.includes('Update')) {
      result.push({
        ...
        userRight: ability.can(ACTIONS.MANAGE, SUBJECTS.PLATFORM_USERS_GROUPS_AND_ROLES),
      });
    }
    if (actions.includes('Delete')) {
      result.push({
        ...
        userRight: ability.can(ACTIONS.DELETE, SUBJECTS.PLATFORM_USERS_GROUPS_AND_ROLES),
      });
    }
    return result;
