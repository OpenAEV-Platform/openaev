...
const ExpectationFormCreate: FunctionComponent<Props> = ({
  ...
  const [expectationType, setExpectationType] = useState<string>(predefinedExpectations ? predefinedExpectations[0].expectation_type : 'MANUAL');

  const manualExpectationExpirationTime = useExpectationExpirationTime(predefinedExpectations ? predefinedExpectations[0].expectation_type as InjectExpectation['inject_expectation_type'] : 'MANUAL');
