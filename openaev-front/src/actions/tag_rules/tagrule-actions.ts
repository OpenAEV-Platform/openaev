...
export const addTagRule = (data: TagRuleInput) => {
  return simplePostCall<TagRuleOutput>(`${TAG_RULES_URI}`, data);
};
...
export const updateTagRule = (
  ...
  return simplePutCall<TagRuleOutput>(uri, data);
};
