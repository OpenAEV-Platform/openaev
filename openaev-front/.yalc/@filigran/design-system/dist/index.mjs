    ...
    return /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: loading ? /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx("span", { className: labelGradientClass, children }),
          /* @__PURE__ */ jsx("span", { role: "status", className: "sr-only", children: "Loading\u2026" })
        ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          startIcon && /* @__PURE__ */ jsx("span", { className: "inline-flex shrink-0", "aria-hidden": "true", children: startIcon }),
          /* @__PURE__ */ jsx("span", { className: labelGradientClass, children }),
          endIcon && /* @__PURE__ */ jsx("span", { className: "inline-flex shrink-0", "aria-hidden": "true", children: endIcon })
        ] })
      }
    );
  }
...
var iconVariants = cva2("inline-block shrink-0", {
  variants: {
    size: {
      16: "size-4",
      20: "size-5",
...
function Icon(props) {
  ...
  if (gradient) {
    return /* @__PURE__ */ jsxs3("span", { ...a11yProps, className: cn(iconVariants({ size }), "relative", className), children: [
      /* @__PURE__ */ jsx3("svg", { width: "0", height: "0", "aria-hidden": "true", className: "absolute", children: /* @__PURE__ */ jsx3("defs", { children: /* @__PURE__ */ jsx3("mask", { id: maskId, maskUnits: "userSpaceOnUse", x: "0", y: "0", width: size, height: size, children: /* @__PURE__ */ jsx3(Glyph, { width: size, height: size, color: "white" }) }) }) }),
      /* @__PURE__ */ jsx3(
        "span",
        {
          className: cn(
...
var IconMeta = {
  ...
  render() {
    ...
    const row = (children) => h("div", { className: "flex items-center gap-4 text-default-primary" }, ...children);
    return h(
      "div",
      ...
      h(
        ...
        row([
          ...
          h(Icon, { name: "chart-column" }),
          h(Icon, { name: "shield-check" }),
      ...
      h(
        ...
        row([
          h(Icon, { name: "custom/filigran" }),
          h(Icon, { name: "custom/malware" }),
          h(Icon, { name: "custom/intrusion-set" }),
          h(Icon, { name: "custom/opencti" }),
          h(Icon, { name: "custom/xtmone" }),
          h(Icon, { name: "custom/slack" })
        ])
      ),
      h(
        "div",
        ...
        row([h(Icon, { name: "circle-alert", "aria-label": "Warning" })])
      ),
      h(
        "div",
        { className: "flex flex-col gap-2" },
        ...
        row([
          h(Icon, { name: "bolt", gradient: "ia" }),
          h(Icon, { name: "custom/filigran", gradient: "ia" }),
          h(Icon, { name: "bolt", gradient: "focus" }),
          h(Icon, { name: "custom/filigran", gradient: "focus" })
        ])
      )
    );
  },
...
var ButtonMeta = {
  ...
  render() {
    ...
    return h2(
      ...
      h2("p", { className: sectionClass }, "Variant \xD7 Priority"),
      h2(
        "div",
        ...
        h2(
          ...
          h2("span", { className: "w-28 shrink-0" }),
          h2("span", { className: sectionClass }, "primary"),
          h2("span", { className: sectionClass }, "secondary"),
          h2("span", { className: sectionClass }, "tertiary")
        ),
        ...grid.map(
          (row) => h2(
            "div",
            ...
            h2("span", { className: labelClass }, row.variant),
            ...["primary", "secondary", "tertiary"].map(
              (priority) => row.priorities.includes(priority) ? h2(Button, { key: priority, variant: row.variant, priority }, `${row.variant}`) : h2(
                "span",
                {
                  key: priority,
      ...
      // Section 2: Sizes
      h2("p", { className: sectionClass }, "Sizes"),
      h2(
        "div",
        { className: "flex items-center gap-4" },
        h2(Button, { size: "sm" }, "Small"),
        h2(Button, { size: "md" }, "Medium")
      ),
      // Section 3: With icons
      h2("p", { className: sectionClass }, "With icons"),
      h2(
        "div",
        { className: "flex items-center gap-4 flex-wrap" },
        h2(Button, { startIcon: h2(Icon, { name: "plus", size: 16 }) }, "Start icon"),
        h2(Button, { endIcon: h2(Icon, { name: "chevron-down", size: 16 }) }, "End icon"),
        h2(
          Button,
          {
            priority: "secondary",
            startIcon: h2(Icon, { name: "plus", size: 16 })
          },
          "Add item"
        )
      ),
      // Section 4: States
      h2("p", { className: sectionClass }, "States"),
      h2(
        "div",
        { className: "flex items-center gap-4 flex-wrap" },
        h2(Button, { disabled: true }, "Disabled primary"),
        h2(Button, { priority: "secondary", disabled: true }, "Disabled secondary"),
        h2(Button, { priority: "tertiary", disabled: true }, "Disabled tertiary"),
        h2(Button, { loading: true }, "Loading")
      ),
      // Section 5: fullWidth
      h2("p", { className: sectionClass }, "Full width"),
      h2(Button, { fullWidth: true }, "Full width button")
    );
  },
  examples: [
  ...
  ({ className, variant, priority, size, icon, active, type = "button", ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx4(
      "button",
      {
        ...
        ...props,
        children: /* @__PURE__ */ jsx4("span", { className: "inline-flex shrink-0", "aria-hidden": "true", children: icon })
      }
    );
  }
);
...
var IconButtonMeta = {
  ...
  render() {
    const iconEl = (name) => h3(Icon, { name, size: 24 });
    const iconIaEl = (name) => h3(Icon, { name, size: 24, gradient: "ia" });
    const iconSmEl = (name) => h3(Icon, { name, size: 16 });
    ...
    return h3(
      ...
      h3(
        "div",
        { className: "flex flex-col gap-2" },
        h3("span", { className: labelClass }, "Primary"),
        h3(
          "div",
          { className: "flex items-center gap-4" },
          h3(IconButton, {
      ...
      h3(
        "div",
        { className: "flex flex-col gap-2" },
        h3("span", { className: labelClass }, "Secondary"),
        h3(
          "div",
          { className: "flex items-center gap-4" },
          h3(IconButton, {
      ...
      h3(
        "div",
        { className: "flex flex-col gap-2" },
        h3("span", { className: labelClass }, "Tertiary"),
        h3(
          "div",
          { className: "flex items-center gap-4" },
          h3(IconButton, {
      ...
      h3(
        "div",
        { className: "flex flex-col gap-2" },
        h3("span", { className: labelClass }, "Small (sm)"),
        h3(
          "div",
          { className: "flex items-center gap-4" },
          h3(IconButton, {
      ...
      h3(
        "div",
        { className: "flex flex-col gap-2" },
        h3("span", { className: labelClass }, "Disabled"),
        h3(
          "div",
          { className: "flex items-center gap-4" },
          h3(IconButton, {
...
var DialogContent = React5.forwardRef(({ className, size, hideCloseButton = false, children, ...props }, ref) => {
  ...
  return /* @__PURE__ */ jsxs4(DialogPrimitive.Portal, { children: [
    ...
    /* @__PURE__ */ jsxs4(
      DialogPrimitive.Content,
      {
        ...
        children: [
          !hideCloseButton && /* @__PURE__ */ jsx5(DialogPrimitive.Close, { asChild: true, children: /* @__PURE__ */ jsx5(
            IconButton,
            {
              icon: /* @__PURE__ */ jsx5(Icon, { name: "x", size: 24, "aria-hidden": true }),
              "aria-label": "Close",
              priority: "tertiary",
              size: "md",
...
var DialogBody = React5.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsx5("div", { ref, className: cn("flex-1 min-h-0 overflow-y-auto", className), ...props })
);
...
var Tabs = React6.forwardRef(
  ({ activationMode = "manual", ...props }, forwardedRef) => /* @__PURE__ */ jsx6(TabsPrimitive.Root, { ref: forwardedRef, activationMode, ...props })
);
          ...
          children: [
            canScrollLeft && /* @__PURE__ */ jsx6(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx6(Icon, { name: "chevron-left", size: 16 })
              }
            ),
            /* @__PURE__ */ jsxs5("div", { className: "relative flex-1 min-w-0", children: [
              /* @__PURE__ */ jsx6(
                TabsPrimitive.List,
                {
                  ref: mergedRef,
            ...
            canScrollRight && /* @__PURE__ */ jsx6(
              "button",
              {
                ...
                onClick: () => scrollByStep(1),
                className: arrowButtonClassName,
                children: /* @__PURE__ */ jsx6(Icon, { name: "chevron-right", size: 16 })
              }
            ),
            actions != null && actions !== false && /* @__PURE__ */ jsx6("div", { className: "flex items-center gap-2 shrink-0 pl-8", children: actions })
          ]
        }
      )
    );
    ...
    return /* @__PURE__ */ jsx6(
      TabsPrimitive.Trigger,
      {
        ...
        children: asChild ? (
          ...
          icon && /* @__PURE__ */ jsx6("span", { className: "flex-none w-4 h-4", "aria-hidden": "true", children: icon }),
          children,
          showBadge && /* @__PURE__ */ jsx6(
            "span",
            {
              className: cn(
                "inline-flex items-center justify-center",
...
<TabsTrigger value="settings" asChild>
  ...
  render() {
    const demoIcon = h4(
      ...
      h4("circle", { cx: 8, cy: 8, r: 5.5 }),
      h4("path", { d: "M8 5.5v3l1.5 1.5", strokeLinecap: "round" })
    );
    ...
    const renderDemoActions = () => [
      h4(Button, { key: "export", priority: "secondary", size: "sm" }, "Export"),
      h4(Button, { key: "new", priority: "primary", size: "sm" }, "New")
    ];
    ...
    return h4(
      ...
      h4(
        "div",
        { className: "flex flex-col gap-2" },
        h4("p", { className: labelClass }, "Basic \u2014 active / default / disabled"),
        h4(
          Tabs,
          ...
          h4(
            TabsList,
            null,
            h4(TabsTrigger, { value: "overview" }, "Overview"),
            h4(TabsTrigger, { value: "reports" }, "Reports"),
            h4(TabsTrigger, { value: "settings", disabled: true }, "Settings")
          ),
          h4(
            TabsContent,
            { value: "overview" },
      ...
      h4(
        "div",
        { className: "flex flex-col gap-2" },
        h4("p", { className: labelClass }, "With icon and badge"),
        h4(
          Tabs,
          { defaultValue: "overview" },
          h4(
            TabsList,
            null,
            h4(TabsTrigger, { value: "overview", icon: demoIcon }, "Overview"),
            h4(TabsTrigger, { value: "reports", badge: 12 }, "Reports"),
            h4(TabsTrigger, { value: "alerts", icon: demoIcon, badge: 3 }, "Alerts")
          ),
          h4(
            TabsContent,
            { value: "overview" },
            h4("p", { className: pClass }, "Tab with a leading icon (16\xD716, aria-hidden).")
          ),
          h4(
            TabsContent,
            { value: "reports" },
            h4("p", { className: pClass }, "Tab with a badge count next to the label.")
          ),
          h4(
            TabsContent,
            { value: "alerts" },
            h4("p", { className: pClass }, "Tab with both a leading icon and a badge count.")
          )
        )
      ),
      ...
      h4(
        ...
        h4(
          ...
          h4(
            TabsList,
            null,
            h4(TabsTrigger, { value: "overview", badge: 12, badgeColor: "brand" }, "Overview"),
            h4(TabsTrigger, { value: "failed", badge: 4, badgeColor: "error" }, "Failed"),
            h4(
              TabsTrigger,
          ...
          h4(
            TabsContent,
            { value: "overview" },
            h4("p", { className: pClass }, 'Default badgeColor ("brand") \u2014 unchanged visual.')
          ),
          h4(
            TabsContent,
            { value: "failed" },
      ...
      h4(
        ...
        h4(
          ...
          h4(
            TabsList,
            null,
            h4(TabsTrigger, { value: "zero-cap", badge: 3, badgeMax: 0 }, "Zero cap"),
            h4(TabsTrigger, { value: "invalid-cap", badge: 3, badgeMax: -1 }, "Invalid cap")
          ),
          h4(
            TabsContent,
            { value: "zero-cap" },
      ...
      h4(
        "div",
        { className: "flex flex-col gap-2" },
        h4("p", { className: labelClass }, "With actions \u2014 right-aligned, sibling of the tablist"),
        h4(
          Tabs,
          { defaultValue: "overview" },
          h4(
          ...
          h4(
            ...
            h4(
              ...
              overflowTriggerLabels.map(
                (label) => h4(TabsTrigger, { key: label, value: label.toLowerCase() }, label)
              )
            ),
            overflowTriggerLabels.map(
              (label) => h4(
                ...
                h4("p", { className: pClass }, `${label} panel.`)
              )
            )
          )
        )
...
var TextRenderFn = React7.forwardRef(
  ({ as, variant, className, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx7(Component, { ref, className: cn(textVariants({ variant }), className), ...props, children });
  }
);
...
var TextMeta = {
  ...
  render() {
    ...
    const stack = (children) => h5("div", { className: "flex flex-col gap-3" }, ...children);
    const sample = (variant, text) => h5(Text2, { key: variant, variant, children: text });
    const linkSample = (variant, text) => h5(Text2, { key: variant, variant, as: "a", href: "#", children: text });
    return h5(
      "div",
      { className: "flex flex-col gap-8" },
      h5(
  ...
  render() {
    ...
    return h6(
      ...
      h6(
        TabsList,
        null,
        h6(TabsTrigger, { value: "sm" }, "Small"),
        h6(TabsTrigger, { value: "md" }, "Medium (default)"),
        h6(TabsTrigger, { value: "lg" }, "Large"),
        h6(TabsTrigger, { value: "scroll" }, "Long content"),
        h6(TabsTrigger, { value: "no-description" }, "No description"),
        h6(TabsTrigger, { value: "hidden-close" }, "Hidden close button")
      ),
      ...
      h6(
        ...
        h6(
          ...
          h6(
            DialogTrigger,
            { asChild: true },
            h6(Button, { priority: "primary" }, "Delete indicator")
          ),
          h6(
            DialogContent,
            { size: "sm" },
            h6(DialogTitle, null, "Delete this indicator?"),
            h6(DialogDescription, null, "This action cannot be undone."),
            h6(
              DialogFooter,
              null,
              h6(DialogClose, { asChild: true }, h6(Button, { priority: "secondary" }, "Cancel")),
              h6(Button, { priority: "primary" }, "Next Step")
            )
          )
        )
      ),
      ...
      h6(
        ...
        h6(
          Dialog,
          null,
          h6(DialogTrigger, { asChild: true }, h6(Button, { priority: "primary" }, "Create label")),
          h6(
            DialogContent,
            null,
            h6(DialogTitle, null, "Create label"),
            h6(
              DialogDescription,
              null,
      ...
      h6(
        ...
        h6(
          ...
          h6(
            DialogTrigger,
            { asChild: true },
            h6(Button, { priority: "primary" }, "Import STIX bundle")
          ),
          h6(
            DialogContent,
            { size: "lg" },
            h6(DialogTitle, null, "Import STIX bundle"),
            h6(
              DialogDescription,
              null,
      ...
      h6(
        ...
        h6(
          Dialog,
          null,
          h6(DialogTrigger, { asChild: true }, h6(Button, { priority: "primary" }, "View changelog")),
          h6(
            DialogContent,
            null,
            h6(DialogTitle, null, "Changelog"),
            h6(DialogDescription, null, "Recent platform updates."),
            h6(DialogBody, null, ...longBody),
            h6(
              DialogFooter,
              null,
              h6(DialogClose, { asChild: true }, h6(Button, { priority: "secondary" }, "Cancel")),
      ...
      h6(
        ...
        h6(
          Dialog,
          null,
          h6(DialogTrigger, { asChild: true }, h6(Button, { priority: "primary" }, "Sign out")),
          h6(
            DialogContent,
            { size: "sm" },
            h6(DialogTitle, null, "Sign out?"),
            h6(
              DialogFooter,
              null,
              h6(DialogClose, { asChild: true }, h6(Button, { priority: "secondary" }, "Cancel")),
      ...
      h6(
        ...
        h6(
          Dialog,
          null,
          h6(DialogTrigger, { asChild: true }, h6(Button, { priority: "primary" }, "Start setup")),
          h6(
            DialogContent,
            { hideCloseButton: true },
            h6(DialogTitle, null, "Step 1 of 3 \u2014 Connect a source"),
            h6(
              DialogDescription,
              null,
...
var Input = React8.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs6("div", { className: cn("flex w-full flex-col gap-2", className), children: [
      label && /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsx8(
          "label",
          {
            htmlFor: inputId,
        ...
        infoTooltip && /* @__PURE__ */ jsx8("span", { className: "inline-flex items-center", children: infoTooltip })
      ] }),
      /* @__PURE__ */ jsxs6("div", { className: "relative w-full", children: [
        ...
        showErrorIcon && /* @__PURE__ */ jsx8(
          "span",
          {
            "aria-hidden": "true",
            className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4 text-input-error",
            children: /* @__PURE__ */ jsx8(Icon, { name: "circle-alert", size: 16, "aria-hidden": true })
          }
        ),
        showSuccessIcon && /* @__PURE__ */ jsx8(
          "span",
          {
            "aria-hidden": "true",
            className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4 text-feedback-success-primary",
            children: /* @__PURE__ */ jsx8(Icon, { name: "circle-check", size: 16, "aria-hidden": true })
          }
        ),
        !hasStateIcon && endIcon && endIcon.type === "iconButton" && /* @__PURE__ */ jsx8("span", { className: "absolute inset-y-0 right-0 flex items-center pr-2", children: /* @__PURE__ */ jsx8(
          IconButton,
          {
            icon: endIcon.icon,
        ...
        !hasStateIcon && endIcon && endIcon.type === "icon" && /* @__PURE__ */ jsx8(
          "span",
          {
            "aria-hidden": "true",
            className: cn(
      ...
      showHelperRow && /* @__PURE__ */ jsxs6("div", { id: helperId, className: "flex items-start justify-between gap-2", children: [
        helperMessage && /* @__PURE__ */ jsx8(
          "span",
          {
            className: cn(
        ...
        maxLength !== void 0 && /* @__PURE__ */ jsxs6(
          "span",
          {
            className: cn(
...
var TooltipContent = React9.forwardRef(({ className, sideOffset = 8, ...props }, ref) => /* @__PURE__ */ jsx9(TooltipPrimitive.Portal, { children: /* @__PURE__ */ jsx9(
    ...
    return h7(
      ...
      h7(
        ...
        h7(
          "div",
          { className: "flex flex-col gap-2" },
          h7("span", { className: labelClass }, "Placements"),
          h7(
            "div",
            ...
            h7(
              Tooltip,
              null,
              h7(TooltipTrigger, { className: triggerClass }, "Left"),
              h7(TooltipContent, { side: "left" }, "Left placement")
            ),
            h7(
              Tooltip,
              null,
              h7(TooltipTrigger, { className: triggerClass }, "Top"),
              h7(TooltipContent, { side: "top" }, "Top placement")
            ),
            h7(
              Tooltip,
              null,
              h7(TooltipTrigger, { className: triggerClass }, "Bottom"),
              h7(TooltipContent, { side: "bottom" }, "Bottom placement")
            ),
            h7(
              Tooltip,
              null,
              h7(TooltipTrigger, { className: triggerClass }, "Right"),
              h7(TooltipContent, { side: "right" }, "Right placement")
            )
          )
        ),
        ...
        h7(
          "div",
          { className: "flex flex-col gap-2" },
          h7("span", { className: labelClass }, "Icon trigger (no visible label)"),
          h7(
            "div",
            ...
            h7(
              ...
              h7(TooltipContent, { side: "right" }, "Show API token details")
            )
          )
        ),
        ...
        h7(
          "div",
          { className: "flex flex-col gap-2" },
          h7("span", { className: labelClass }, "Jargon definition"),
          h7(
            "div",
            { className: "flex items-center gap-4 py-4" },
            h7(
        ...
        h7(
          "div",
          { className: "flex flex-col gap-2" },
          h7("span", { className: labelClass }, "Truncated text with full content"),
          h7(
            "div",
            { className: "flex items-center gap-4 py-4" },
            h7(
...
var NavbarItem = React13.forwardRef(
  ({
    ...
    const row = asChild ? /* @__PURE__ */ jsx10(
      Slot2,
      {
        ref,
      ...
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx10("span", { className: cn("flex-1 truncate text-left", collapsed && "sr-only"), children }),
          chevron && !collapsed && /* @__PURE__ */ jsx10(
            "span",
            {
              ...
              "aria-hidden": "true",
              children: /* @__PURE__ */ jsx10(Icon, { name: "chevron-down", size: 16 })
            }
          )
        ]
      }
    ...
    return /* @__PURE__ */ jsx10(TooltipProvider, { children: /* @__PURE__ */ jsxs7(Tooltip, { children: [
      /* @__PURE__ */ jsx10(TooltipTrigger, { asChild: true, children: row }),
      /* @__PURE__ */ jsx10(TooltipContent, { side: "right", children: collapsedTooltipContent })
    ] }) });
  }
);
...
var Navbar = React14.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx11(NavbarContext.Provider, { value: { collapsed }, children: /* @__PURE__ */ jsxs8(
      "nav",
      {
        ref,
        className: cn(
        ...
        children: [
          /* @__PURE__ */ jsxs8("div", { className: "flex min-h-0 flex-1 flex-col", children: [
            ...
            /* @__PURE__ */ jsx11("div", { className: "flex flex-1 flex-col gap-1 overflow-y-auto py-2", children })
          ] }),
          /* @__PURE__ */ jsxs8("div", { className: "flex shrink-0 flex-col gap-1 py-2", children: [
            footer,
            /* @__PURE__ */ jsx11(
              NavbarItem,
              {
                icon: /* @__PURE__ */ jsx11(Icon, { name: collapsed ? "panel-left-open" : "panel-left-close", size: 16 }),
...
var NavbarItemMeta = {
  ...
  render() {
    ...
    return h8(
      ...
      h8("p", { className: sectionClass }, "States (expanded)"),
      h8(
        "div",
        { className: "flex flex-col gap-1 w-45 border border-elevation-subtle rounded-sm p-2" },
        h8(NavbarItem, { icon: h8(Icon, { name: "house", size: 16 }), children: "Default" }),
        h8(NavbarItem, {
          icon: h8(Icon, { name: "shield", size: 16 }),
          "aria-current": "page",
          children: "Selected"
        }),
        h8(NavbarItem, {
          icon: h8(Icon, { name: "settings", size: 16 }),
          disabled: true,
          children: "Disabled"
        })
      ),
      // Section 2: Chevron (submenu trigger look)
      h8("p", { className: sectionClass }, "With chevron (submenu trigger)"),
      h8(
        "div",
        { className: "flex flex-col gap-1 w-45 border border-elevation-subtle rounded-sm p-2" },
        h8(NavbarItem, {
          icon: h8(Icon, { name: "book", size: 16 }),
          chevron: true,
          children: "Knowledge"
        })
      ),
      // Section 3: showIcon=false (submenu preference)
      h8("p", { className: sectionClass }, "showIcon=false (submenu icon preference)"),
      h8(
        "div",
        { className: "flex flex-col gap-1 w-45 border border-elevation-subtle rounded-sm p-2" },
        h8(NavbarItem, { showIcon: false, children: "Text-only label" })
      ),
      // Section 4: Collapsed Navbar (icon-only + Tooltip)
      h8("p", { className: sectionClass }, "Collapsed ancestor Navbar (icon-only, Tooltip-wrapped)"),
      h8(
        ...
        h8(
          ...
          h8(NavbarItem, { icon: h8(Icon, { name: "house", size: 16 }), children: "Home" }),
          h8(NavbarItem, {
            icon: h8(Icon, { name: "shield", size: 16 }),
            "aria-current": "page",
            children: "Threats"
      ...
      h8("p", { className: sectionClass }, "asChild (router Link)"),
      h8(
        "div",
        { className: "flex flex-col gap-1 w-45 border border-elevation-subtle rounded-sm p-2" },
        h8(NavbarItem, {
          asChild: true,
          children: h8("a", { href: "#", "aria-current": "page" }, "Dashboard")
        })
      ),
          ...
          h8(NavbarItem, {
            ...
            children: h8(
              ...
              h8(
                ...
                h8(Icon, { name: "house", size: 16 })
              ),
              h8("span", { className: "flex-1 truncate text-left sr-only" }, "Dashboard")
            )
          })
        )
      )
...
var NavbarSubmenuItem = React15.forwardRef(
  ({ className, asChild = false, icon, showIcon = true, children, ...props }, ref) => {
    if (asChild) {
      return /* @__PURE__ */ jsx12(Slot3, { ref, className: cn(navbarSubmenuItemClass, className), ...props, children });
    }
    return /* @__PURE__ */ jsxs9("a", { ref, className: cn(navbarSubmenuItemClass, className), ...props, children: [
      showIcon && icon && /* @__PURE__ */ jsx12("span", { className: "inline-flex shrink-0", "aria-hidden": "true", children: icon }),
      /* @__PURE__ */ jsx12("span", { className: "flex-1 truncate text-left", children })
    ] });
  }
);
...
function NavbarSubmenu({
  ...
  if (collapsed) {
    return (
      ...
      /* @__PURE__ */ jsxs9(DropdownMenuPrimitive.Root, { open: isOpen, onOpenChange: handleRadixOpenChange, modal: false, children: [
        /* @__PURE__ */ jsx12(
            ...
            children: linkHref ? (
              ...
              /* @__PURE__ */ jsx12(
                NavbarItem,
                {
                  ...
                  children: /* @__PURE__ */ jsxs9("a", { href: linkHref, onPointerDown: markSuppressToggleFromLink, children: [
                    icon && /* @__PURE__ */ jsx12(
                      "span",
                      {
                    ...
                    /* @__PURE__ */ jsx12("span", { className: "flex-1 truncate text-left sr-only", children: label })
                  ] })
                }
              )
            ) : /* @__PURE__ */ jsx12(
        ...
        /* @__PURE__ */ jsx12(DropdownMenuPrimitive.Portal, { children: /* @__PURE__ */ jsx12(
          DropdownMenuPrimitive.Content,
          {
            ...
            children: React15.Children.map(children, (child) => /* @__PURE__ */ jsx12(DropdownMenuPrimitive.Item, { asChild: true, children: child }))
          }
        ) })
      ] })
    );
  ...
  return /* @__PURE__ */ jsx12(
    AccordionPrimitive.Root,
    {
      ...
      children: /* @__PURE__ */ jsxs9(AccordionPrimitive.Item, { value: ACCORDION_ITEM_VALUE, children: [
        /* @__PURE__ */ jsx12(AccordionPrimitive.Header, { asChild: true, children: /* @__PURE__ */ jsx12("div", { children: /* @__PURE__ */ jsx12(AccordionPrimitive.Trigger, { asChild: true, ref: triggerRef, children: /* @__PURE__ */ jsx12(
          NavbarItem,
          {
            icon,
            chevron: true,
        ...
        /* @__PURE__ */ jsx12(
          AccordionPrimitive.Content,
          {
            ...
            onFocus: handleContentFocus,
            onBlur: handleContentBlur,
            children: /* @__PURE__ */ jsx12("div", { className: "flex flex-col", children })
          }
        )
      ] })
    }
...
function ProductSwitcherOptionItem({ option }) {
  ...
  const body = /* @__PURE__ */ jsxs10(Fragment3, { children: [
    /* @__PURE__ */ jsx13("span", { className: "inline-flex shrink-0 items-center", "aria-hidden": "true", children: option.logo }),
    /* @__PURE__ */ jsxs10("span", { className: "sr-only", children: [
      option.label,
      external && " (opens in a new tab)"
    ] }),
    external && /* @__PURE__ */ jsx13("span", { className: "ml-auto inline-flex shrink-0", "aria-hidden": "true", children: /* @__PURE__ */ jsx13(Icon, { name: "external-link", size: 16 }) })
  ] });
  let element;
  ...
  if (option.href) {
    ...
    element = /* @__PURE__ */ jsx13("a", { href: option.to, className: productSwitcherItemClass, children: body });
  } else {
    element = /* @__PURE__ */ jsx13("div", { className: cn(productSwitcherItemClass, "cursor-default opacity-60"), children: body });
  }
  const item = /* @__PURE__ */ jsx13(DropdownMenuPrimitive2.Item, { asChild: true, disabled: inert, children: element });
  if (!option.tooltip) {
    return item;
  }
  return /* @__PURE__ */ jsxs10(Tooltip, { children: [
    /* @__PURE__ */ jsx13(TooltipTrigger, { asChild: true, children: item }),
    /* @__PURE__ */ jsx13(TooltipContent, { side: "left", children: option.tooltip })
  ] });
}
var ProductSwitcher = React16.forwardRef(
  ({ className, logo, label, options, ...props }, ref) => {
    const collapsed = useNavbarCollapsed();
    const logoSpan = /* @__PURE__ */ jsx13("span", { className: "inline-flex h-7 shrink-0 items-center overflow-hidden", "aria-hidden": "true", children: logo });
    const menu = /* @__PURE__ */ jsx13(DropdownMenuPrimitive2.Portal, { children: /* @__PURE__ */ jsx13(
      DropdownMenuPrimitive2.Content,
      {
        ...
        children: /* @__PURE__ */ jsx13(TooltipProvider, { children: options.map((option) => /* @__PURE__ */ jsx13(ProductSwitcherOptionItem, { option }, option.id)) })
      }
    ) });
    if (collapsed) {
      return /* @__PURE__ */ jsxs10(DropdownMenuPrimitive2.Root, { children: [
        /* @__PURE__ */ jsx13(
    ...
    return /* @__PURE__ */ jsxs10(DropdownMenuPrimitive2.Root, { children: [
      /* @__PURE__ */ jsxs10("div", { className: "flex h-9 w-full items-center justify-between", children: [
        logoSpan,
        /* @__PURE__ */ jsx13(DropdownMenuPrimitive2.Trigger, { asChild: true, children: /* @__PURE__ */ jsx13(
          IconButton,
          {
            ref,
            icon: /* @__PURE__ */ jsx13("span", { className: "transition-transform duration-150 motion-reduce:transition-none group-data-[state=open]:rotate-180", children: /* @__PURE__ */ jsx13(Icon, { name: "chevron-down", size: 16 }) }),
            size: "sm",
            priority: "tertiary",
            className: cn(
              "group",
...
var NavbarMeta = {
  ...
  render() {
    const demoItems = (withSubmenu) => [
      h9(NavbarItem, {
        key: "dashboard",
        icon: h9(Icon, { name: "layout-panel-left", size: 16 }),
        "aria-current": "page",
        children: "Dashboard"
      }),
      h9(NavbarItem, {
        key: "analyses",
        icon: h9(Icon, { name: "chart-bar", size: 16 }),
        children: "Analyses"
      }),
      h9(NavbarSeparator, { key: "sep-1" }),
      withSubmenu ? h9(NavbarSubmenu, {
        key: "knowledge",
        label: "Knowledge",
        icon: h9(Icon, { name: "book", size: 16 }),
        defaultOpen: true,
        children: [
          h9(NavbarSubmenuItem, { key: "reports", href: "#", children: "Reports" }),
          h9(NavbarSubmenuItem, { key: "malware", href: "#", children: "Malware" })
        ]
      }) : h9(NavbarItem, {
        key: "knowledge",
        icon: h9(Icon, { name: "book", size: 16 }),
      ...
      h9(NavbarSeparator, { key: "sep-2" }),
      h9(NavbarItem, {
        key: "settings",
        icon: h9(Icon, { name: "settings", size: 16 }),
        children: "Settings"
      })
    ];
    const demoHeader = h9(ProductSwitcher, {
      logo: h9(Icon, { name: "custom/opencti", size: 20 }),
      label: "More Filigran products",
      options: [
        {
          id: "openaev",
          label: "OpenAEV",
          logo: h9(Icon, { name: "custom/openaev", size: 20 }),
...
import { createElement as h10 } from "react";
var NavbarSubmenuMeta = {
  ...
  render() {
    ...
    return h10(
      ...
      h10("p", { className: sectionClass }, "Expanded Navbar (accordion mode)"),
      h10(
        "div",
        { className: "flex flex-col w-56 border border-elevation-subtle rounded-sm p-2" },
        h10(NavbarSubmenu, {
          label: "Knowledge",
          icon: h10(Icon, { name: "book", size: 16 }),
          defaultOpen: true,
          children: [
            h10(NavbarSubmenuItem, { key: "reports", href: "#", children: "Reports" }),
            h10(NavbarSubmenuItem, {
              key: "malware",
              href: "#",
              "aria-current": "page",
              children: "Malware"
            ...
            h10(NavbarSubmenuItem, {
              key: "observables",
              href: "#",
              icon: h10(Icon, { name: "settings", size: 16 }),
      ...
      h10("p", { className: sectionClass }, "NavbarSubmenuItem showIcon=false"),
      h10(
        "div",
        { className: "flex flex-col w-56 border border-elevation-subtle rounded-sm p-2" },
        h10(NavbarSubmenu, {
          label: "Analysis",
          defaultOpen: true,
          children: h10(NavbarSubmenuItem, {
            href: "#",
            icon: h10(Icon, { name: "book", size: 16 }),
            showIcon: false,
      ...
      h10("p", { className: sectionClass }, "Collapsed ancestor Navbar (flyout mode)"),
      h10(
        NavbarContext.Provider,
        { value: { collapsed: true } },
        h10(
      ...
      h10("p", { className: sectionClass }, "NavbarSubmenuItem asChild (router Link)"),
      h10(
        "div",
        { className: "flex flex-col w-56 border border-elevation-subtle rounded-sm p-2" },
        h10(NavbarSubmenu, {
          ...
          children: h10(NavbarSubmenuItem, {
            asChild: true,
            children: h10("a", { href: "#", "aria-current": "page" }, "Users")
          })
        })
      ),
...
import { createElement as h11 } from "react";
...
var ProductSwitcherMeta = {
  ...
  render() {
    ...
    return h11(
      ...
      h11("p", { className: sectionClass }, "Expanded Navbar (logo + chevron trigger)"),
      h11(
        "div",
        { className: "flex flex-col w-56 border border-elevation-subtle rounded-sm p-2" },
        h11(ProductSwitcher, {
      ...
      h11("p", { className: sectionClass }, "Option anatomy (external vs internal destination)"),
      h11(
        "div",
        ...
        h11(
          ...
          h11("span", { className: "sr-only" }, "OpenAEV (opens in a new tab)"),
          h11(
            "span",
            { className: "ml-auto inline-flex shrink-0", "aria-hidden": "true" },
            h11(Icon, { name: "external-link", size: 16 })
          )
        ),
        h11(
          "p",
        ...
        h11(
          ...
          h11("span", { className: "sr-only" }, "XTM Hub")
        ),
        h11(
          "p",
          { className: `${sectionClass} px-2` },
    ...
    SwitchPrimitive.Root,
    {
      ...
      children: /* @__PURE__ */ jsx15(
        SwitchPrimitive.Thumb,
        {
          ...
          children: /* @__PURE__ */ jsx15("svg", { viewBox: "0 0 16 16", width: 16, height: 16, "aria-hidden": "true", className: "block size-4", children: /* @__PURE__ */ jsx15(
            "circle",
            {
              cx: "8",
              cy: "8",
...
import { createElement as h12 } from "react";
...
var SwitchMeta = {
  ...
  render() {
    ...
    return h12(
      "div",
      { className: "flex flex-col gap-6" },
      h12("p", { className: sectionClass }, "Unchecked / checked (uncontrolled)"),
      h12(
        "div",
        { className: rowClass },
      ...
      h12("p", { className: sectionClass }, "Disabled"),
      h12(
        "div",
        { className: rowClass },
      ...
      h12("p", { className: sectionClass }, "With integrated label"),
      h12(
        "div",
        { className: "flex flex-col items-start gap-3" },
        h12(Switch, { label: "Enable notifications" }),
        h12(Switch, { label: "Enable notifications (checked)", defaultChecked: true }),
        h12(Switch, { label: "Enable notifications (disabled)", disabled: true })
      )
    );
  },
  examples: [
