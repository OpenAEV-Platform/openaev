...
class InjectExpectationServiceTest extends IntegrationTest {
  ...
  void expectationsForAssetLinkedToAgent() {
    ...
    assertEquals(
        ...
        injectExpectationRepository
            .findAllForAsset(savedInject.getId(), savedAsset.getId())
            .size());
    assertEquals(
        2,
        injectExpectationRepository
            .findAllForAgent(savedInject.getId(), savedAgent.getId())
            .size());
  }
  ...
  void expectationsForAssetGroupLinkedToAgent() {
    ...
    assertEquals(
        2,
        injectExpectationRepository
            .findAllForAssetGroup(savedInject.getId(), savedAssetGroup.getId())
            .size());
    assertEquals(
        2,
        injectExpectationRepository
  ...
  void expectationsForAssetWithMultipleAgents() {
    ...
    assertEquals(
        2,
        injectExpectationRepository
            .findAllForAgent(savedInject.getId(), savedAgent1.getId())
            .size());
  }
