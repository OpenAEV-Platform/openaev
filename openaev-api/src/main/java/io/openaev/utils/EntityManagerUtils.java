...
public class EntityManagerUtils {
    ...
    public <T> T findEntity(Class<T> entityClass, Object entityId) {
        try {
            ...
            log.debug("[EntityManagerUtils] Failed to find entity {}/{}: {}", entityClass, entityId, e.getMessage());
        }
        return null;
    }
    ...
    public <T> JsonNode snapshotEntity(Class<T> entityClass, Object entityId) {
        try {
            ...
            log.debug("[EntityManagerUtils] Failed to snapshot entity {}/{}: {}", entityClass, entityId, e.getMessage());
        }
        return null;
    }
