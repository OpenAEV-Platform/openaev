...
public class UserAuthApi extends RestBehavior {
  ...
  public User login(@Valid @RequestBody LoginUserInput input) {
    ...
    if (optionalUser.isPresent()) {
      ...
      if (userAuthService.isUserPasswordValid(user, input.getPassword())) {
        userAuthService.createUserSession(user);
  ...
  public User changePasswordReset(
    ...
    if (userId != null) {
      ...
      changeUser.setPassword(userAuthService.encodeUserPassword(password));
  ...
  public User changePassword(
    ...
    user.setPassword(userAuthService.encodeUserPassword(input.getPassword()));
