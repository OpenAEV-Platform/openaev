...
public class PayloadService {
  ...
  public InjectorContract synchroniseInjectorContractBasedOnPayload(
    ...
    Injector openaevInjector =
        this.injectorRepository
            .findByTypeAndTenantId(OpenAEVImplantContract.TYPE, payload.getTenant().getId())
            .orElseThrow();
    ...
    setInjectorContractPropertyBasedOnPayload(
        injectorContractToUpdate, payload, attackPatterns, domains, tags, openaevInjector);
