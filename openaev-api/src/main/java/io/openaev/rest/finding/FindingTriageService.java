...
public class FindingTriageService {
  ...
  private void applyTransition(
    ...
    // A triage change is a human action: bump humanUpdateDate ("Updated at" filter), not
    // updateDate ("Last seen", reserved for scanner detection - see Finding#updateDate).
