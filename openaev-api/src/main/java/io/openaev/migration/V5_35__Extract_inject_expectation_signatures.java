...
@Component
public class V5_35__Extract_inject_expectation_signatures extends BaseJavaMigration {
      ...
      statement.execute(
          """
              CREATE TABLE IF NOT EXISTS injects_expectations_signatures (
                  ...
                  inject_expectation_created_at TIMESTAMP NOT NULL DEFAULT now(),
...
// FROM (
//    SELECT
//        ier.inject_expectation_signature_inject_expectation_id::text AS inject_expectation_id,
//        jsonb_agg(
//            jsonb_build_object(
//                'type', ier.inject_expectation_signature_type,
//                'value', ier.inject_expectation_signature_value
//            )
//            ORDER BY ier.inject_expectation_created_at
//        ) AS signatures
//    FROM injects_expectations_signatures ier
//    GROUP BY ier.inject_expectation_signature_inject_expectation_id
// ) sub
