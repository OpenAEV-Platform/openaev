...
public class V4_51__Add_Connector_Instance_Logs extends BaseJavaMigration {
  ...
  public void migrate(Context context) throws Exception {
    try (Statement select = context.getConnection().createStatement()) {
      ...
      //            select.execute(
      //               """
      //               CREATE TYPE connector_instance_current_status_type AS ENUM ('started',
      // 'stopped');
      //               CREATE TYPE connector_instance_requested_status_type AS ENUM ('starting',
      // 'stopping');
      //               """
      //            );
      //            select.execute(
      ...
      //              ADD COLUMN connector_instance_current_status
      // connector_instance_current_status_type NOT NULL,
      //              ADD COLUMN connector_instance_requested_status
      // connector_instance_requested_status_type NOT NULL
      //              """);
    }
  }
}
