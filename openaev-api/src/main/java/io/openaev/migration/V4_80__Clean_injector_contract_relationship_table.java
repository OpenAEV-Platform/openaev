...
@Component
public class V4_80__Clean_injector_contract_relationship_table extends BaseJavaMigration {
  ...
  public void migrate(Context context) throws Exception {
    try (Statement statement = context.getConnection().createStatement()) {
      ...
      statement.execute(
          """
                      CREATE TABLE IF NOT EXISTS injector_contract_tags (
                          ...
                          PRIMARY KEY (injector_contract_id, tag_id),
      ...
      statement.execute(
          """
                      INSERT INTO injector_contract_tags (injector_contract_id, tag_id)
                      SELECT DISTINCT ic.injector_contract_id, pt.tag_id
      ...
      statement.execute(
          """
                      ...
                      SELECT DISTINCT ic.injector_contract_id, pd.domain_id
                      FROM injectors_contracts ic
                      JOIN payloads p ON ic.injector_contract_payload = p.payload_id
