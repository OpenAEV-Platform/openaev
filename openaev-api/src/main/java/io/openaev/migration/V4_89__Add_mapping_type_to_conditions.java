...
@Component
public class V4_89__Add_mapping_type_to_conditions extends BaseJavaMigration {
  ...
  public void migrate(Context context) throws Exception {
    try (Statement stmt = context.getConnection().createStatement()) {
      ...
      stmt.execute("ALTER TABLE conditions ADD COLUMN IF NOT EXISTS condition_key varchar(256);");
      stmt.execute(
          "UPDATE conditions "
