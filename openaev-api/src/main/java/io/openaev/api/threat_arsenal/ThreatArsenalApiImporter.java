...
public class ThreatArsenalApiImporter {
  ...
  public ThreatArsenalAction importJson(TxCtx ctx, @RequestPart("file") @NotNull MultipartFile file)
      throws Exception {
    return threatArsenalImportService.importThreatArsenalAction(ctx, file);
  }
}
