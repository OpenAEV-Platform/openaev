...
public class UserMapper {
   ...
   *
   * <p>Requires the entity to have been loaded with the "Player.tags-organization" EntityGraph so
   * that organization and tags are eagerly fetched. If they are not initialized, a
