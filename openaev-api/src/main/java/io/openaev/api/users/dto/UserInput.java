...
public record UserInput(
        ...
        @JsonProperty("user_phone") @Pattern(regexp = "^$|^\\+[\\d\\s\\-.()]+$", message = PHONE_FORMAT) String phone,
        @JsonProperty("user_phone2") @Pattern(regexp = "^$|^\\+[\\d\\s\\-.()]+$", message = PHONE_FORMAT) String phone2,
