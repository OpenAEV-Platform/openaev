...
/**
 * Request body for the XTM One detection-remediation proxy endpoint. {@code agentSlug} is
 * optional: when null/blank the service falls back to the first enabled {@code detection.generate}
 * agent in the discovered catalog.
 */
