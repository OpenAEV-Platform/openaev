...
public class CapabilityMapper {
    ...
    public static CapabilityOutput toOutput(Capability capability, List<CapabilityOutput> children) {
        return new CapabilityOutput(
                capability.name(),
                capability.isCheckable(),
                scopeNames(capability),
                children);
    }

    public static CapabilityOutput toOutput(CapabilityGroup capability, List<Capability> groupRoots, List<CapabilityOutput> children) {
        return new CapabilityOutput(
                capability.name(),
                false,
                scopeNames(groupRoots),
                children);
    }
