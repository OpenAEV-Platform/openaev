...
import io.openaev.api.user.form.me.UpdateMePasswordInput;
import io.openaev.api.user.form.me.UpdateProfileInput;
import io.openaev.api.user.form.user.RenewTokenInput;
import io.openaev.api.user.form.user.UpdateUserInfoInput;
