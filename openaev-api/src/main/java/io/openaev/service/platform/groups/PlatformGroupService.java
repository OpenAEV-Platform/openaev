...
public class PlatformGroupService {
  ...
  @Transactional(readOnly = true)
  public Page<PlatformGroup> search(SearchPaginationInput searchPaginationInput) {
    return buildPaginationJPA(
        platformGroupRepository::findAll, searchPaginationInput, PlatformGroup.class);
  }
  ...
  public void deletePlatformGroup(@NotBlank final String groupId) {
    ...
    platformGroupRepository.deleteById(groupId);
  }
}
