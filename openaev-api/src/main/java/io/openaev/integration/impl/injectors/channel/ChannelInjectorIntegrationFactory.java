...
import static io.openaev.integration.impl.injectors.channel.ChannelInjectorIntegration.CHANNEL_INJECTOR_ID;
  ...
  public List<ConnectorInstance> findRelatedInstances(String tenantId) {
    return List.of(
        connectorInstanceService.createAutostartInstance(
            resolveConnectorId(CHANNEL_INJECTOR_ID, tenantId),
            this.getClassName(),
