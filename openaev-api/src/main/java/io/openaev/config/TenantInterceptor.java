 ...
 *
 * <p>The PostgreSQL {@code app.current_tenant} session variable is set per-transaction by {@link
 * io.openaev.aop.HibernateFilterTransactionAspect}, which runs inside the transactional boundary
 * where the JDBC connection is pinned for the duration of the transaction.
 */
@Component
