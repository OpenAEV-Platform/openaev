...
import io.openaev.utils.mockConfig.executors.WithMockPaloAltoCortexConfig;
...
public class PaloAltoCortexExecutorConfigurationMigrationTest {
  ...
  @WithMockPaloAltoCortexConfig(
      enable = true,
      url = "paloaltocortex_url",
      apiKey = "paloaltocortex_api_key",
      apiKeyId = "paloaltocortex_api_key_id",
      apiRegisterInterval = 1234,
      groupName = "paloaltocortex_group_name",
      cleanImplantInterval = 4321,
      apiBatchExecutionActionPagination = 5678,
      windowsScriptId = "windowsScriptId",
      unixScriptId = "unixScriptId")
  @DisplayName("With enabled configuration")
  public class WithEnabledConfiguration {

    @Autowired
    private PaloAltoCortexExecutorConfigurationMigration
    ...
    @Autowired private PaloAltoCortexExecutorConfig beanConfig;
    ...
    public void whenConfigIsEnabled_resultingInstanceIsRunning() throws Exception {
      ...
      AssertionsForInterfaceTypes.assertThat(instance.getRequestedStatus())
    ...
    public void whenConfigIsEnabled_itMigratesTheConfig() throws Exception {
      ...
      assertThat(instance).isInstanceOf(ConnectorInstancePersisted.class);
      AssertionsForInterfaceTypes.assertThat(instance.getConfigurations())
      ...
      assertThat("paloaltocortex_api_key")
          .isNotEqualTo(
              instance.getConfigurations().stream()
                  .filter(
                      connectorInstanceConfiguration ->
                          "EXECUTOR_PALOALTOCORTEX_API_KEY"
