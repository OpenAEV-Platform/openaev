...
class UserAuthApiTest extends IntegrationTest {
  ...
  class LoggingIn {
    ...
    class LoggingInByEmail {
      ...
      @Test
      @WithMockUser
      void given_known_login_user_input_in_uppercase_should_return_user() throws Exception {
        LoginUserInput loginUserInput = UserFixture.getLoginUserInput();
        loginUserInput.setLogin(loginUserInput.getLogin().toUpperCase());
