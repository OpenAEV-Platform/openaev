...
class InjectorExecutionProcessingHandlerTest {
  ...
  @Test
  @DisplayName("Should process finding-compatible elements and trigger processors")
  void testProcessFindings() throws Exception {
    String key = "vuln_id";
    String jsonOutput = "{\"" + key + "\": \"CVE-2026-1234\"}";
    ExecutionProcessingContext ctx = createValidCtx(jsonOutput);
