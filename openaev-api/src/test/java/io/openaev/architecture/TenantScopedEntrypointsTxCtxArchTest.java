...
class TenantScopedEntrypointsTxCtxArchTest {
  ...
  private static final Set<String> TX_SCOPED_ENTRYPOINTS =
      Set.of(
          // import_mappers (v2)
          "io.openaev.api.import_mapper.MapperApi#getImportMapper",
          "io.openaev.api.import_mapper.MapperApi#getImportMapperById",
          "io.openaev.api.import_mapper.MapperApi#createImportMapper",
          "io.openaev.api.import_mapper.MapperApi#exportMappers",
          "io.openaev.api.import_mapper.MapperApi#importMappers",
          "io.openaev.api.import_mapper.MapperApi#duplicateMapper",
          "io.openaev.api.import_mapper.MapperApi#updateImportMapper",
          "io.openaev.api.import_mapper.MapperApi#deleteImportMapper",
          ...
          "io.openaev.api.import_mapper.MapperApi#testImportXLSFile",
