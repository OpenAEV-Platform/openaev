...
/**
 * Guards that the production configuration keeps {@code connector_instances} activated in v2. The
 ...
 */
@DisplayName("Production config keeps connector_instances activated (v2)")
class ConnectorInstanceActivationConfigTest {

  @Test
  @DisplayName(
      "openaev.tenant.active-tables in application.properties contains connector_instances")
  void prodConfigActivatesConnectorInstances() throws Exception {
