...
| inject.execution.concurrency                | INJECT_EXECUTION_CONCURRENCY                | CPU cores             | Size of the dedicated thread pool used to execute scheduled injects in parallel. Defaults to the number of available CPU cores when unset.                                                 |
