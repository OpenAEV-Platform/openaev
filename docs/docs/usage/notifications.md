As of today, OpenAEV has only one notification type: scenario score degradation. This alert emails you when a scenario's simulation score drops below the score of the previous run.
